  ...
  if (loading) {
    return (
      <div className="flex-1 p-6 bg-gradient-to-br from-[#000000] via-[#1a1a1a] to-[#2a2a2a]">
        <div className="text-white">Loading Risk Parameters...</div>
      </div>
    )
  }
  ...
  return (
    <div className="flex-1 p-6 space-y-6 bg-gradient-to-br from-[#000000] via-[#1a1a1a] to-[#2a2a2a]">
      <div className="bg-black/40 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-[#B58342]/20">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-[#B58342] to-[#d4a05a] bg-clip-text text-transparent">Attrition Risk Parameters</h1>
        <p className="text-slate-300 mt-2">Comprehensive risk assessment methodology and scoring system</p>
      </div>

      <RiskParameters employees={allEmployees} />
    </div>
  )
}
